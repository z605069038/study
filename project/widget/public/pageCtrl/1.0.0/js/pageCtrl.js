 ...
 * @description 禁毒一体化平台产品推养而生的分页控件。
 ...
 * @param theme为主题，目前提供shuyin和jidu
 ...
 * @example
    ...
    js:
    var PageCtrl = require('widget/public/pageCtrl/1.0.0/js/pageCtrl'),
...
ctrl.prototype.init = function(opt,theme){
    var _this = this;
    if(_this.inited){
        _this.reset(opt);
        return;
