...
;(function () {
    ...
    /**
     * Determine whether a given element requires a contacts to focus to simulate click into element.
     *
     * @param {EventTarget|Element} target Target DOM element
     * @returns {boolean} Returns true if the element requires a contacts to focus to simulate native click.
     */
